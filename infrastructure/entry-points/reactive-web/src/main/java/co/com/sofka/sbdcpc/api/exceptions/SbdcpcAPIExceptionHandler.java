...
@Component
public class SbdcpcAPIExceptionHandler extends AbstractErrorWebExceptionHandler {
    public SbdcpcAPIExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources,
